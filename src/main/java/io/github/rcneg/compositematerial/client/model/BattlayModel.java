...
@OnlyIn(Dist.CLIENT)
public class BattlayModel extends HierarchicalModel<Battlay> implements ArmedModel {
    ...
    public BattlayModel(ModelPart p_171045_) {
    ...
    public void setupAnim(Battlay p_104028_, float p_104029_, float p_104030_, float p_104031_, float p_104032_, float p_104033_) {
