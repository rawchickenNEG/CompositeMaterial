...
public class VanitatiumPickaxe extends PickaxeItem implements IVanitatiumReplaceable {
    public final Item replaceItem;
    public VanitatiumPickaxe(Tier p_40521_, int p_40522_, float p_40523_, Properties p_40524_, Item replacement) {
