...
public class AllaySteelSwordReinforced extends SwordItem {
    public AllaySteelSwordReinforced(Tier p_42961_, int p_42962_, float p_42963_, Properties p_42964_) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn)
    {
        ...
        tooltip.add(Component.translatable("tooltip.composite_material.allay_steel_sword_reinforced").withStyle(ChatFormatting.DARK_PURPLE));
    }
}
