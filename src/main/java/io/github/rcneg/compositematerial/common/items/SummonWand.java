...
public class SummonWand extends TippedItems implements Vanishable {
    public SummonWand(Properties p_41383_) {
        super(p_41383_);
    }

    public ItemStack finishUsingItem(ItemStack itemStack, Level level, LivingEntity entity) {
        if(entity instanceof Player player){
            DungeonZombie dungeonZombie = EntityTypeRegistry.DUNGEON_ZOMBIE.get().create(level);
            dungeonZombie.setPos(entity.getX(), entity.getY() + entity.getEyeHeight(), entity.getZ());
            dungeonZombie.setOwner(player);
            dungeonZombie.setEquipments(
            ...
            dungeonZombie.setLimitedLife(3600);
